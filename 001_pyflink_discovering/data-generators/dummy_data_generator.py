...
# Declaring faker to generate the testing data
fake = Faker()
# Defining the start time to be processed
start_time = time.time()
# Defining of transactions to be mimified 
...
def generate_random_users() -> List[str]:
    """
    Intends to generate random users
...
def get_random_user(users: List[str]) -> str:
    """
    Selects and returns a random user name
...
def get_usage_amount() -> List[int]:
    """
    Shuffles and returns a random combination of amount
...
def get_usage_date():
    """
    Returns a fake datetime time range
    """
...
if __name__ == '__main__':
    ...
    while current_datetime <= end_datetime:
        ...
        for row in data_usage.itertuples():
            ...
            data = {
                    'customer': str(data_customer),
                    'transaction_type': str(data_transaction_type),
                    'online_payment_amount': str(data_online_payment_amount),
                    'in_store_payment_amount': str(data_in_store_payment_amount),
                    'lat': str(data_lat),
                    'lon': str(data_lon),
                    'transaction_datetime': str(data_transaction_datetime)
                    }
